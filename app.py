...
# FIX: Changed unsafe_allow_name_with_html to unsafe_allow_html
st.markdown("""
    <style>
...
if sample_f and blank_f:
    try:
        ...
        purity_val = (len(df_final)/total*100) if total > 0 else 0
        c4.metric("Purity Score", f"{purity_val:.1f}%")
        ...
        with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
            ...
            ws_d.write('B6', 'Purity Score'); ws_d.write('C6', f"{purity_val:.2f}%")
